...
std::optional<Algorithm> CreateDekRequest::getAlgorithm() const { return algorithm_; }
std::optional<std::string> CreateDekRequest::getEncryptedKeyMaterial() const { return encryptedKeyMaterial_; }

// Setters
void CreateDekRequest::setSubject(const std::string& subject) { subject_ = subject; }
void CreateDekRequest::setVersion(const std::optional<int32_t>& version) { version_ = version; }
void CreateDekRequest::setAlgorithm(const std::optional<Algorithm>& algorithm) { algorithm_ = algorithm; }
void CreateDekRequest::setEncryptedKeyMaterial(const std::optional<std::string>& encryptedKeyMaterial) { encryptedKeyMaterial_ = encryptedKeyMaterial; }
