...
bool Schema::operator==(const Schema &rhs) const {
    return schemaType_ == rhs.schemaType_ && references_ == rhs.references_ &&
           metadata_ == rhs.metadata_ && ruleSet_ == rhs.ruleSet_ &&
           schema_ == rhs.schema_;
}

bool Schema::operator!=(const Schema &rhs) const { return !(*this == rhs); }
...
std::optional<std::string> Schema::getSchemaType() const { return schemaType_; }
...
Schema::getReferences() const {
    return references_;
}

void Schema::setReferences(
    const std::optional<
        std::vector<schemaregistry::rest::model::SchemaReference>> &value) {
    references_ = value;
}

std::optional<schemaregistry::rest::model::Metadata> Schema::getMetadata()
    const {
    return metadata_;
}

void Schema::setMetadata(
    const std::optional<schemaregistry::rest::model::Metadata> &value) {
    metadata_ = value;
}

std::optional<schemaregistry::rest::model::RuleSet> Schema::getRuleSet() const {
    return ruleSet_;
}

void Schema::setRuleSet(
    const std::optional<schemaregistry::rest::model::RuleSet> &value) {
    ruleSet_ = value;
}

std::optional<std::string> Schema::getSchema() const { return schema_; }
