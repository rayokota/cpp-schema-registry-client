...
bool Metadata::operator==(const Metadata &rhs) const {
    return tags_ == rhs.tags_ && properties_ == rhs.properties_ &&
           sensitive_ == rhs.sensitive_;
}

bool Metadata::operator!=(const Metadata &rhs) const { return !(*this == rhs); }

void to_json(nlohmann::json &j, const Metadata &o) {
    j = nlohmann::json::object();
    if (o.tags_.has_value()) j["tags"] = o.tags_.value();
    if (o.properties_.has_value()) j["properties"] = o.properties_.value();
    if (o.sensitive_.has_value()) j["sensitive"] = o.sensitive_.value();
}
...
Metadata::getTags() const {
    return tags_;
}

void Metadata::setTags(
