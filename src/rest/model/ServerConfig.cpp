...
bool ServerConfig::operator==(const ServerConfig &rhs) const {
    return compatibility_ == rhs.compatibility_ &&
           compatibilityLevel_ == rhs.compatibilityLevel_ &&
           alias_ == rhs.alias_ && normalize_ == rhs.normalize_ &&
...
void to_json(nlohmann::json &j, const ServerConfig &o) {
    ...
    if (o.alias_.has_value()) j["alias"] = o.alias_.value();
    if (o.normalize_.has_value()) j["normalize"] = o.normalize_.value();
...
void ServerConfig::setCompatibility(
    const std::optional<CompatibilityLevel> &value) {
...
void ServerConfig::setCompatibilityLevel(
    const std::optional<CompatibilityLevel> &value) {
    compatibilityLevel_ = value;
}

std::optional<std::string> ServerConfig::getAlias() const { return alias_; }

void ServerConfig::setAlias(const std::optional<std::string> &value) {
    alias_ = value;
}

std::optional<bool> ServerConfig::isNormalize() const { return normalize_; }
...
void ServerConfig::setCompatibilityGroup(
