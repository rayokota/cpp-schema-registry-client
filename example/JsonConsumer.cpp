...
class JsonConsumerExample {
 ...
 public:
  JsonConsumerExample(const std::string& brokers, const std::string& group_id,
...
int main(int argc, char* argv[]) {
  ...
  std::cout << "Starting JSON consumer with configuration:" << std::endl;
  ...
  try {
    JsonConsumerExample consumer(brokers, group_id, schema_registry_url);
