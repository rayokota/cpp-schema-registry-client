...
class AvroConsumerEncryptionExample {
 private:
 ...
 public:
  AvroConsumerEncryptionExample(const std::string& brokers, const std::string& group_id,
...
int main(int argc, char* argv[]) {
  ...
  std::cout << "Starting Avro consumer with encryption support:" << std::endl;
  ...
  try {
    AvroConsumerEncryptionExample consumer(brokers, group_id, schema_registry_url);
