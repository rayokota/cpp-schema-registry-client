...
#ifndef SRCLIENT_RULES_ENCRYPTION_LOCAL_KMS_DRIVER_H_
#define SRCLIENT_RULES_ENCRYPTION_LOCAL_KMS_DRIVER_H_
...
#endif // SRCLIENT_RULES_ENCRYPTION_LOCAL_KMS_DRIVER_H_ 