...
class AvroSchema : public SerdeSchema {
  ...
  public:
    explicit AvroSchema(
        const std::pair<::avro::ValidSchema, std::vector<::avro::ValidSchema>>
            &schema)
        : schema_(schema) {}
...
inline std::unique_ptr<SerdeSchema> makeAvroSchema(
    const std::pair<::avro::ValidSchema, std::vector<::avro::ValidSchema>>
        &avro_schema) {
...
inline std::pair<::avro::ValidSchema, std::vector<::avro::ValidSchema>>
asAvroSchema(const SerdeSchema &schema) {
